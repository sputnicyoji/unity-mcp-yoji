...
namespace MCPForUnity.Editor.Helpers
{
    ...
    {
        /// <summary>
        /// Checks whether a type belongs to the built-in Yoji Unity MCP package.
        /// Returns true when the type's namespace starts with
        /// <paramref name="builtInNamespacePrefix"/> or its assembly is Yoji.UnityMcp.Editor.
        /// </summary>
        public static bool IsBuiltInMcpType(Type type, string assemblyName, string builtInNamespacePrefix)
        {
            ...
            if (!string.IsNullOrEmpty(assemblyName)
                && assemblyName.Equals("Yoji.UnityMcp.Editor", StringComparison.Ordinal))
            {
                return true;
            }
