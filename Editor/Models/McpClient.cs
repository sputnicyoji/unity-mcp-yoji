...
namespace MCPForUnity.Editor.Models
{
    public class McpClient
    {
        ...
        public bool UsesServersLayout; // Whether the config file uses a legacy servers layout
        ...
        public string HttpTypeValue; // Override for the HTTP transport "type" value (null => "http")
        public string StdioTypeValue; // Override for the stdio transport "type" value (null => "stdio")
        public string ServerContainerKey; // Top-level JSON container key for servers (null => "mcpServers")
        public string SchemaUrl; // Optional root "$schema" URL written into the config
