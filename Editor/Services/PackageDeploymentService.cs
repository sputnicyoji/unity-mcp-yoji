...
namespace MCPForUnity.Editor.Services
{
    ...
    public class PackageDeploymentService : IPackageDeploymentService
    {
        ...
        public PackageDeploymentResult DeployFromStoredSource()
        {
            ...
            try
            {
                EditorUtility.DisplayProgressBar("Deploy Yoji Unity MCP", "Creating backup...", 0.25f);
                string backupPath = CreateBackup(targetPath);

                EditorUtility.DisplayProgressBar("Deploy Yoji Unity MCP", "Replacing package contents...", 0.7f);
        ...
        public PackageDeploymentResult RestoreLastBackup()
        {
            ...
            try
            {
                EditorUtility.DisplayProgressBar("Restore Yoji Unity MCP", "Restoring backup...", 0.5f);
