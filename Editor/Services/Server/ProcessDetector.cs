        ...
        public bool LooksLikeMcpServerProcess(int pid)
        {
            try
            {
                ...
                if (Application.platform == RuntimePlatform.WindowsEditor)
                {
                    ...
                    {
                        bool mentionsMcp = wmicCompact.Contains("yoji-unity-mcp")
                                           || wmicCompact.Contains("mcp_for_unity")
                                           || wmicCompact.Contains("mcpforunity")
                                           || wmicCompact.Contains("yoji-unity-mcp-server");
                ...
                // Use -ww to avoid truncating long command lines (important for reliably spotting 'yoji-unity-mcp').
                ...
                {
                    bool mentionsMcp = sCompact.Contains("yoji-unity-mcp")
                    ...
                    // Note: Check before Unity exclusion since "yoji-unity-mcp" contains "unity".
                    if (mentionsMcp)
                    {
                        return true;
                    }
