...
{
    /// <summary>
    /// Service for controlling the Yoji Unity MCP Bridge connection
    /// </summary>
    public interface IBridgeControlService
    {
        ...
        /// <summary>
        /// Starts the Yoji Unity MCP Bridge asynchronously
        /// </summary>
        /// <returns>True if the bridge started successfully</returns>
        Task<bool> StartAsync();

        /// <summary>
        /// Stops the Yoji Unity MCP Bridge asynchronously
        /// </summary>
        Task StopAsync();
