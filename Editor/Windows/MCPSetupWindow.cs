...
namespace MCPForUnity.Editor.Windows
{
    ...
    public class MCPSetupWindow : EditorWindow
    {
        ...
        private void PopulateClientsList()
        {
            ...
            {
                clientsList.Add(new Label("No supported MCP clients detected on this machine. You can configure clients later from Tools → Yoji Unity MCP."));
        ...
        private void UpdateUI()
        {
            ...
            {
                statusMessage.text = "✓ All requirements met! Yoji Unity MCP is ready to use.";
                statusMessage.style.color = new StyleColor(Color.green);
                installationSection.style.display = DisplayStyle.None;
            }
            else
            {
                statusMessage.text = "⚠ Missing dependencies. Yoji Unity MCP requires all dependencies to function.";
