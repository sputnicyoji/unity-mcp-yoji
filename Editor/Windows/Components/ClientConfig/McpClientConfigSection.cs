...
{
    /// <summary>
    /// Controller for the Client Configuration section of the Yoji Unity MCP editor window.
    ...
    public class McpClientConfigSection
    {
        ...
        private void UpdateInstallSkillsVisibility()
        {
            ...
            // Personal fork: remote skill synchronization is removed to avoid outbound GitHub requests.
            installSkillsButton.style.display = DisplayStyle.None;
        }

        private void OnInstallSkillsClicked()
        {
            EditorUtility.DisplayDialog(
                "Install Skills Disabled",
                "Remote skill synchronization is disabled in this personal fork.",
                "OK");
        }
