    ...
    public class McpAdvancedSection
    {
        ...
        private void InitializeUI()
        {
            ...
            if (gitUrlOverride != null)
                gitUrlOverride.tooltip = "Override server source for uvx --from. Leave empty to use bundled Server~. Example local dev: /path/to/unity-mcp/Server~";
            ...
            if (clearGitUrlButton != null)
                clearGitUrlButton.tooltip = "Clear override and use bundled Server~";
        ...
        private static string ResolveServerPath(string path)
        {
            ...
            // If path is not a local filesystem path, return as-is (git URLs and package refs)
