...
namespace MCPForUnity.Editor.Windows
{
    public class MCPForUnityEditorWindow : EditorWindow
    {
        ...
        public static void ShowWindow()
        {
            ...
            {
                window = GetWindow<MCPForUnityEditorWindow>("Yoji Unity MCP");
            }

            window.titleContent = new GUIContent("Yoji Unity MCP");
        ...
        private void UpdateVersionLabel()
        {
            ...
            versionLabel.tooltip = AssetPathUtility.IsPreReleaseVersion()
                ? $"Yoji Unity MCP v{version} (pre-release package, using prerelease server channel)"
                : $"Yoji Unity MCP v{version}";
        }
