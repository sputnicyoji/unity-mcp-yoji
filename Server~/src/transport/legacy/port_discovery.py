"""
Port discovery utility for Yoji Unity MCP Server.
...
- This module now scans for both patterns, prefers the most recently
  modified file, and verifies that the port is actually a Yoji Unity MCP listener
...
class PortDiscovery:
    ...
    def _try_probe_unity_mcp(port: int) -> bool:
        """Quickly check if a Yoji Unity MCP listener is on this port.
